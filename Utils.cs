...
namespace FivePD_HostageScenarioCallout
{
    internal class Utils
    {
        ...
        public static Prop GetClosestObjectToCoords(float x, float y, float z, float buffer = 0.2f, string modelName = null)
        {
        ...
        public static async Task PedTaskLaptopHackAnimation(Ped ped, int duration = 10000)
        {
            ...
            int bagscene = Function.Call<int>(Hash.NETWORK_CREATE_SYNCHRONISED_SCENE, hacker.Position.X - 0.5f, hacker.Position.Y, hacker.Position.Z + 0.4f, hacker.Rotation.X, hacker.Rotation.Y, hacker.Rotation.Z, 2, false, false, 1065353216, 0, 1.3);
            ...
            int hackscene = Function.Call<int>(Hash.NETWORK_CREATE_SYNCHRONISED_SCENE, hacker.Position.X - 0.5f,hacker.Position.Y,hacker.Position.Z + 0.4f,hacker.Rotation.X,hacker.Rotation.Y,hacker.Rotation.Z,2,false,true, 1065353216,0,1);
            ...
            int hackexit = Function.Call<int>(Hash.NETWORK_CREATE_SYNCHRONISED_SCENE, hacker.Position.X - 0.5f, hacker.Position.Y, hacker.Position.Z + 0.4f, hacker.Rotation.X, hacker.Rotation.Y, hacker.Rotation.Z, 2, false, false, 1065353216, -1, 1.3);
        ...
        public static JObject GetConfig()
        {
            ...
            catch (Exception err)
            {
                ...
                Debug.WriteLine("^1===================================================================================================");
                Debug.WriteLine("^8ERROR (Kilo's 24/7 Robbery Callout)^7: ^2 The above line will allow the callout to read the json files here in the callout folder!");
            }
            return result;
        }
